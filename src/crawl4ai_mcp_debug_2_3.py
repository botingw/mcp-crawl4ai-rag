...
"""
# from mcp.server.fastmcp import FastMCP, Context # debug, try import from fastmcp package directly
...
# from crawl4ai import AsyncWebCrawler, BrowserConfig, CrawlerRunConfig, CacheMode, MemoryAdaptiveDispatcher # Removed for debugging
...
async def crawl4ai_lifespan(server: FastMCP) -> AsyncIterator[Crawl4AIContext]:
    ...
    try:
        yield Crawl4AIContext(
            crawler=None, # Set to None for debugging
...
mcp = FastMCP(
    "mcp-crawl4ai-rag",
    # description="MCP server for RAG and web crawling with Crawl4AI", # debug, seems outdated
    lifespan=crawl4ai_lifespan,
    host=os.getenv("HOST", "0.0.0.0"),
    port=os.getenv("PORT", "8051"),
    # settings={"initialization_timeout": 30.0} # debug, seems outdated
)
